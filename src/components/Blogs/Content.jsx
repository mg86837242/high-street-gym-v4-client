...
export default function Content() {
  return (
    <div
      ...
      className='flex flex-col w-full h-full px-4 py-6 max-w-screen-2xl min-h-[calc(100vh-7.5rem)]'
    >
      <Editor />
    </div>
  );
...
function Editor() {
  ...
  return (
    <div className='flex flex-col gap-8 px-4 py-6 border border-base-content rounded-3xl'>
      <MenuBar editor={editor} />
      <EditorContent editor={editor} />
      <div className='flex justify-end w-full gap-10 mt-5'>
        <button type='button' className='w-20 btn btn-outline btn-primary btn-sm'>
          Edit
        </button>
