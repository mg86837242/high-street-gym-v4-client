...
export default function SignupPanel() {
  return (
    <div
      ...
      className='flex flex-col w-full max-w-lg md:max-w-2xl gap-6 px-5 py-8 lg:px-10 lg:pt-12 lg:pb-8 my-auto bg-neutral rounded-3xl shadow-[0_0_30px_15px_rgba(255,255,255,0.2)]'
    >
      <Directions />
      <SignupForm />
    </div>
